...
<div class="col-md-12">
	<div class="form-group ">
		...
		<textarea name="isi_layanan" class="form-control" placeholder="Isi Layanan"><?php echo $layanan->keywords ?></textarea>
	</div>
	<div class="form-group ">
		<label>Keyword layanan (untuk SEO Google)</label>
		<textarea name="keywords" class="form-control" placeholder="Keywords Layanan"><?php echo $layanan->isi_layanan ?></textarea>
	</div>
