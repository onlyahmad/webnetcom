...
<div class="col-md-12">
	<div class="form-group ">
		...
		<textarea name="isi_berita" class="form-control" placeholder="Isi Berita"><?php echo set_value('keywords') ?></textarea>
	</div>
	<div class="form-group ">
		<label>Keyword berita (untuk SEO Google)</label>
		<textarea name="keywords" class="form-control" placeholder="Keywords Berita"><?php echo set_value('isi_berita') ?></textarea>
	</div>
