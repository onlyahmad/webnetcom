...
<div class="col-md-4">
	<div class="form-group form-group-lg">
		...
		<select name="id_kategori" class="form-control">
			...
			<option value="<?php echo $kategori->id_kategori?>" <?php if($berita->id_kategori==$kategori->id_kategori){echo "selected";} ?>><?php echo $kategori->nama_kategori?></option>
			<?php }; ?>
		</select>
	</div>
</div>
...
<div class="col-md-12">
	<div class="form-group ">
		...
		<textarea name="isi_berita" class="form-control" placeholder="Isi Berita"><?php echo $berita->keywords ?></textarea>
	</div>
	<div class="form-group ">
		<label>Keyword berita (untuk SEO Google)</label>
		<textarea name="keywords" class="form-control" placeholder="Keywords Berita"><?php echo $berita->isi_berita ?></textarea>
	</div>
